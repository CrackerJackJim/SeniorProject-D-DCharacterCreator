...
async function saveCharacter() {
    ...
    const payload = {
        ...
        combat: {
            ...
            speed: getText("combatSpeed"),
            speed_climb: getText("combatSpeedClimb"),
            speed_swim: getText("combatSpeedSwim"),
            speed_fly: getText("combatSpeedFly"),

            hit_dice_total: getText("combatHitDice"),
        ...
        inventory: {
            ...
            armor: getText("inventoryArmor"),
            weapons: getText("inventoryWeapons"),
            tools: getText("inventoryTools"),
            misc_items: getText("inventoryMisc")
        },
